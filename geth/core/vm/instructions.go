...
func opBalance(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	...
	slot.Set(interpreter.evm.StateDB.GetBalance(interpreter.evm.BigToAddress(slot)))
	return nil, nil
}
...
func opExtCodeSize(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	slot := callContext.stack.peek()
	slot.SetUint64(uint64(interpreter.evm.StateDB.GetCodeSize(interpreter.evm.BigToAddress(slot))))
...
func opExtCodeCopy(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	var (
		addr       = interpreter.evm.BigToAddress(callContext.stack.pop())
		memOffset  = callContext.stack.pop()
		codeOffset = callContext.stack.pop()
		length     = callContext.stack.pop()
	)
...
func opExtCodeHash(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	slot := callContext.stack.peek()
	address := interpreter.evm.BigToAddress(slot)
...
func opCall(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	...
	toAddr := interpreter.evm.BigToAddress(addr)
...
func opSuicide(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	...
	interpreter.evm.StateDB.AddBalance(interpreter.evm.BigToAddress(callContext.stack.pop()), balance)
